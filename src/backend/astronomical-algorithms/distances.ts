...
export function distanceModulusFromParsec(
  pc: number,
  visualAbsorption = 0
): number {
...
export function parsecFromDistanceModulus(
  mM: number,
  visualAbsorption = 0
): number {
...
export function redshiftFromMegaparsec(
  Mpc: number,
  hubbleConstant = 72
): number {
...
export function megaparsecFromRedshift(z: number, hubbleConstant = 72): number {
